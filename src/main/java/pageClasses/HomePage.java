...
public class HomePage {
	...
	public void Login(String Username, String Password, String value, String data) throws Exception{
		...
		globalFunctions.Type(userNameTextbox,globalFunctions.readData("C:/Users/pkesari/Desktop/sample.xml", Username),"userNameTextbox");
		globalFunctions.Type(passwordTextbox,globalFunctions.readData("C:/Users/pkesari/Desktop/sample.xml", Password),"passwordTextbox");
		globalFunctions.Click(submitButton, "Submit Button");
		globalFunctions.Click(contactus, "Contact Us");	
		globalFunctions.selectValueBy(subjectDropdown, value, data);
		Thread.sleep(5000);
		globalFunctions.logOut(signOut);
